...
$arsivle = mysql_query("UPDATE musteriler SET arsiv=1 WHERE id='$id'");
if ($arsivle){
    echo "<div class='container text-center alert alert-warning' role='alert'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>Arşivlendi!</div>";;
